...
gambarku = Image.open('D:\Kuliah\Semester 5\Pemrograman Fungsional\Modul6\Gambarku\LOGO UMM.png')  # Ganti dengan path gambar Anda
...
save_path = r'D:\Kuliah\Semester 5\Pemrograman Fungsional\Modul6\Gambarku\Logo_UMM.png'
